function [ss, EA, HG, HG2, HG3, b, RR]=nmr1to3fitbindstatkb(para,initial,DA) %ss is the outcome of this function, it
%%
%               FIT BINDING
%
%
...
HGG=[HG+2*HG2+3*HG3];%Gathers the 1:1 host-guest and 1:2 host-guest*2 values to a

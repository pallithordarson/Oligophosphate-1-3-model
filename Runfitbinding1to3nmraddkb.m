...
[results, fval, exitflag, output] = fminsearch('nmr1to3fitbindaddkb',start1,options,initial,DA);
...
%NEXTLINEVARIABLE (Marker for section that is variable between different fitting programs)   
[ss, EA, HG, HG2, HG3, b, RR]=nmr1to3fitbindaddkb(para,initial,DA);
...
save ('fitted1to3addx4','Fitallstuff','-append');
%end of program.